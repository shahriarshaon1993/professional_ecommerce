                        ...
                        <tbody>
                            @foreach ($brands as $key=>$item)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::to($item->brand_logo) }}" height="30px" width="80px" alt="Brand Logo">
                                    </td>
                                    <td>
                                        <a href="{{ URL::to('edit/brand/'.$item->id) }}" class="btn btn-sm btn-info">Edit</a>
                                        <a href="{{ URL::to('delete/brand/'.$item->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
