    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                ...
                <p class="mg-b-20 mg-sm-b-30">Update</p>
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="post_title_bn" class="form-control" type="text" name="post_title_bn" value="{{ $post->post_title_bn }}">
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="details_en" id="summernote" class="form-control">
                                        {{ $post->details_en }}
                                    </textarea>
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    class="tx-danger">*</span></label>
                                    <textarea name="details_bn" id="summernote1" class="form-control">
                                        {{ $post->details_bn }}
                                    </textarea>
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <label class="custom-file">
                                        ...
                                        <br><br>
                                        <img src="{{ URL::to($post->post_image) }}" width="80px" height="60px" id="one">
                                    </label>
                                </div>
                            </div><!-- col-4 -->
